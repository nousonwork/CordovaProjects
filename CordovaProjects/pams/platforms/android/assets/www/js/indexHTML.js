...
$("#login").click(function(){
	  $.ajax({url:"http://localhost:8080/pams/users/login", 
		  crossDomain:true,
		  type:"POST",
...
$(document).ready(function(){
	$("#attendancein").click(function(){
		
		alert("IN Attendance Recorded.");
		
		});});


$(document).ready(function(){
	$("#attendanceout").click(function(){
		
		alert("OUT Attendance Recorded.");
...
$(document).ready(function(){
	$("#feedback").click(function(){
		...
		alert("Recording...please give your voice feedback.");
...
$(document).ready(function(){
	$("#signup").click(function(){
		  $.ajax({url:"http://118.139.177.195:8443/cabserver/customers/signup", crossDomain:true,
			  type:"POST",
...
$(document).ready(function(){
	$("#update").click(function(){
		  $.ajax({url:"http://118.139.177.195:8443/cabserver/admin/customers/update-customer-data", crossDomain:true,
			  type:"POST",
