...
$("#login").click(function(){
	  $.ajax({url:"http://10.66.127.4:8080/cabserver/customers/login", 
		  crossDomain:true,
		  type:"POST",
...
$(document).ready(function(){
	$("#signup").click(function(){
		  $.ajax({url:"http://10.66.127.4:8080/cabserver/customers/signup", crossDomain:true,
			  type:"POST",
...
$(document).ready(function(){
	$("#update").click(function(){
		  $.ajax({url:"http://10.66.127.4:8080/cabserver/admin/customers/update-customer-data", crossDomain:true,
			  type:"POST",
